    ...
    <table align="center">
        ...
        <tr>
                ...
                <td class="auto-style2">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ControlToValidate="BoxDNI" ErrorMessage="RegularExpressionValidator" Font-Size="Large" ForeColor="#993300" ValidationExpression="(\d{8})">Introduzca un D.N.I. válido, sin espacios</asp:RegularExpressionValidator>
                </td>
            </tr>
        <tr>
        ...
        <tr>
                <td style="margin-top: 40px" colspan="2">
                    <asp:Button ID="ButtonRegistrar" runat="server" style="text-align: center; height: 26px;" Text="Registrar" />
                </td>
            </tr>
        <tr>
                <td style="margin-left: 40px">
        ...
        <asp:Label ID="LabelAnotaciones" runat="server"></asp:Label>
    </form>
</body>
</html>
