<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Registro.aspx.vb" Inherits="Opcional.Registro" %>
    ...
    <table align="center">
        ...
        <tr>
                <td style="margin-top: 40px" colspan="2">
                    <asp:Button ID="ButtonRegistrar" runat="server" style="text-align: center" Text="Registrar" onclick="ButtonRegistrar_Click" />
                </td>
            </tr>
        <tr>
                <td style="margin-left: 40px">
