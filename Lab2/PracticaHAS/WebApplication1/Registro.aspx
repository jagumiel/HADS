    ...
    <table align="center">
        ...
        <tr>
                ...
                <td class="auto-style2">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="BoxNombre" ErrorMessage="RegularExpressionValidator" Font-Size="Large" ForeColor="#993300" ValidationExpression="^ [A-zA-Z0-9] + $">Introduzca un nombre valido.</asp:RegularExpressionValidator>
                </td>
            </tr>
        <tr>
                <td>
                ...
                <td class="auto-style2">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="BoxApellido1" ErrorMessage="RegularExpressionValidator" Font-Size="Large" ForeColor="#993300" ValidationExpression="/^[a-zA-Z]{2,}$/">Introduzca un apellido válido.</asp:RegularExpressionValidator>
                </td>
            </tr>
        <tr>
                ...
                <td class="auto-style5">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="BoxApellido2" ErrorMessage="RegularExpressionValidator" Font-Size="Large" ForeColor="#993300" ValidationExpression="/^[a-zA-Z]{2,}$/">Introduzca un apellido válido.</asp:RegularExpressionValidator>
                </td>
            </tr>
        <tr>
        ...
        <tr>
                ...
                <td class="auto-style3">
                    <asp:TextBox ID="BoxPass" runat="server"></asp:TextBox>
        ...
        <tr>
                ...
                <td class="auto-style2">
                    <asp:TextBox ID="BoxConfPass" runat="server"></asp:TextBox>
        ...
        <tr>
                ...
                <td class="auto-style2">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="BoxRespuesta" ErrorMessage="RegularExpressionValidator" Font-Size="Large" ForeColor="#993300" ValidationExpression="/^[a-zA-Z]{2,}$/">Longitud inadecuada.</asp:RegularExpressionValidator>
                </td>
            </tr>
        <tr>
